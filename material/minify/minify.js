...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
    _gsScope._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function (av, aO) {
        var aJ, ax, aw, aC, aU = function () {
            av.call(this, "css"), this._overwriteProps.length = 0, this.setRatio = aU.prototype.setRatio
        }, aB = _gsScope._gsDefine.globals, aG = {}, aK = aU.prototype = new av("css");
        aK.constructor = aU, aU.version = "1.15.0", aU.API = 2, aU.defaultTransformPerspective = 0, aU.defaultSkewType = "compensated", aK = "px", aU.suffixMap = {
            top        : aK,
            right      : aK,
            bottom     : aK,
            left       : aK,
        ...
        var au, aN, aA, aV, aQ, aP, aD = /(?:\d|\-\d|\.\d|\-\.\d)+/g, aM = /(?:\d|\-\d|\.\d|\-\.\d|\+=\d|\-=\d|\+=.\d|\-=\.\d)+/g, at = /(?:\+=|\-=|\-|\b)[\d\-\.]+[a-zA-Z0-9]*(?:%|\b)/gi, ap = /(?![+-]?\d*\.?\d+|[+-]|e[+-]\d+)[^0-9]/g, aq = /(?:\d|\-|\+|=|#|\.)*/g, a2 = /opacity *= *([^)]*)/i, ar = /opacity:([^;]*)/i, aT = /alpha\(opacity *=.+?\)/i, a7 = /^(rgb|hsl)/, a4 = /([A-Z])/g, br = /-([a-z])/gi, a5 = /(^(?:url\(\"|url\())|(?:(\"\))$|\)$)/gi, aH = function (a, b) {
            return b.toUpperCase()
        }, a8 = /(?:Left|Right|Width)/i, bt = /(M11|M12|M21|M22)=[\d\-\.e]+/gi, bo = /progid\:DXImageTransform\.Microsoft\.Matrix\(.+?\)/i, bc = /,(?=[^\)]*(?:\(|$))/gi, bd = Math.PI / 180, ba = 180 / Math.PI, ao = {}, aY = document, bh = function (a) {
            return aY.createElementNS ? aY.createElementNS("http://www.w3.org/1999/xhtml", a) : aY.createElement(a)
        }, bm = bh("div"), bn = bh("img"), aX = aU._internals = {_specialProps: aG}, bs = navigator.userAgent, a1 = function () {
            var a = bs.indexOf("Android"), b = bh("a");
            return aA = -1 !== bs.indexOf("Safari") && -1 === bs.indexOf("Chrome") && (-1 === a || Number(bs.substr(a + 8, 1)) > 3), aQ = aA && 6 > Number(bs.substr(bs.indexOf("Version/") + 8, 1)), aV = -1 !== bs.indexOf("Firefox"), (/MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(bs) || /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(bs)) && (aP = parseFloat(RegExp.$1)), b ? (b.style.cssText = "top:1px;opacity:.55;", /^0.55/.test(b.style.opacity)) : !1
        }(), aI = function (a) {
            return a2.test("string" == typeof a ? a : (a.currentStyle ? a.currentStyle.filter : a.style.filter) || "") ? parseFloat(RegExp.$1) / 100 : 1
        }, aZ = function (a) {
            window.console && console.log(a)
        }, a0 = "", az = "", bk = function (b, f) {
            f = f || bm;
            var a, d, c = f.style;
            if (void 0 !== c[b]) {
                return b
            ...
            var g;
            return a1 || "opacity" !== f ? (!d && b.style[f] ? g = b.style[f] : (a = a || a6(b)) ? g = a[f] || a.getPropertyValue(f) || a.getPropertyValue(f.replace(a4, "-$1").toLowerCase()) : b.currentStyle && (g = b.currentStyle[f]), null == c || g && "none" !== g && "auto" !== g && "auto auto" !== g ? g : c) : aI(b)
            ...
            var c, e, j, q = a8.test(g), k = v, b = bm.style, m = 0 > a;
            if (m && (a = -a), "%" === w && -1 !== g.indexOf("border")) {
                ...
                k.appendChild(bm), c = parseFloat(bm[q ? "offsetWidth" : "offsetHeight"]), k.removeChild(bm), q && "%" === w && aU.cacheWidths !== !1 && (e = k._gsCache = k._gsCache || {}, e.time = j, e.width = 100 * (c / a)), 0 !== c || d || (c = aW(v, g, a, w, !0))
            }
            return m ? -c : c
            ...
            var d = "left" === f ? "Left" : "Top", c = bl(b, "margin" + d, a);
            ...
            return a1 || (c.opacity = aI(b)), d = bI(b, f, !1), c.rotation = d.rotation, c.skewX = d.skewX, c.scaleX = d.scaleX, c.scaleY = d.scaleY, c.x = d.x, c.y = d.y, bK && (c.z = d.z, c.rotationX = d.rotationX, c.rotationY = d.rotationY, c.scaleZ = d.scaleZ), c.filters && delete c.filters, c
        }, bg = function (p, k, g, b, q) {
            var d, m, c, f = {}, j = p.style;
            for (m in g) {
                "cssText" !== m && "length" !== m && isNaN(m) && (k[m] !== (d = g[m]) || q && q[m]) && -1 === m.indexOf("Origin") && ("number" == typeof d || "string" == typeof d) && (f[m] = "auto" !== d || "left" !== m && "top" !== m ? "" !== d && "auto" !== d && "none" !== d || "string" != typeof k[m] || "" === k[m].replace(ap, "") ? d : 0 : bB(p, m), void 0 !== j[m] && (c = new ab(j, m, j[m], c)))
            }
            if (b) {
                for (m in b) {
                    "className" !== m && (f[m] = b[m])
            ...
            width : ["Left", "Right"],
            height: ["Top", "Bottom"]
        }, ac = ["marginLeft", "marginRight", "marginTop", "marginBottom"], aE = function (b, f, a) {
            var d = parseFloat("width" === f ? b.offsetWidth : b.offsetHeight), c = bp[f], g = c.length;
            ...
            var a = b.split(" "), d = -1 !== b.indexOf("left") ? "0%" : -1 !== b.indexOf("right") ? "100%" : a[0], c = -1 !== b.indexOf("top") ? "0%" : -1 !== b.indexOf("bottom") ? "100%" : a[1];
            return null == c ? c = "0" : "center" === c && (c = "50%"), ("center" === d || isNaN(parseFloat(d)) && -1 === (d + "").indexOf("=")) && (d = "50%"), f && (f.oxp = -1 !== d.indexOf("%"), f.oyp = -1 !== c.indexOf("%"), f.oxr = "=" === d.charAt(1), f.oyr = "=" === c.charAt(1), f.ox = parseFloat(d.replace(ap, "")), f.oy = parseFloat(c.replace(ap, ""))), d + " " + c + (a.length > 2 ? " " + a[2] : "")
        }, bz = function (a, b) {
            ...
            return null == k ? c = h : "number" == typeof k ? c = k : (m = 360, d = k.split("_"), j = Number(d[0].replace(ap, "")) * (-1 === k.indexOf("rad") ? 1 : ba) - ("=" === k.charAt(1) ? 0 : h), d.length && (b && (b[g] = h + j), -1 !== k.indexOf("short") && (j %= m, j !== j % (m / 2) && (j = 0 > j ? j + m : j - m)), -1 !== k.indexOf("_cw") && 0 > j ? j = (j + 9999999999 * m) % m - (0 | j / m) * m : -1 !== k.indexOf("ccw") && j > 0 && (j = (j - 9999999999 * m) % m - (0 | j / m) * m)), c = h + j), f > c && c > -f && (c = 0), c
        }, aL = {
            aqua       : [0, 255, 255],
            lime       : [0, 255, 0],
            silver     : [192, 192, 192],
        ...
        var bE = function (w, p, j, b) {
            ...
            var x, d = p ? (w.match(aR) || [""])[0] : "", q = w.split(d).join("").match(at) || [], c = w.substr(0, w.indexOf(q[0])), g = ")" === w.charAt(w.length - 1) ? ")" : "", k = -1 !== w.indexOf(" ") ? " " : ",", v = q.length, m = v > 0 ? q[0].replace(aD, "") : "";
        ...
        }, ab = (aX._setPluginRatio = function (k) {
        ...
        }), ay = (aX._parseToProxy = function (D, x, q, b, E, k) {
            var A, j, m, v, C, w = b, g = {}, B = {}, z = q._transform, y = ao;
            ...
            this.t = q, this.p = k, this.s = b, this.c = v, this.n = g || k, q instanceof ay || aC.push(this.n), this.r = i, this.type = d || 0, n && (this.pr = n, aJ = !0), this.b = void 0 === j ? b : j, this.e = void 0 === c ? b + v : c, m && (this._next = m, m._prev = this)
        }), ak = aU.parseComplex = function (D, Q, M, G, E, J, X, I, K, N) {
            M = M || J || "", X = new ay(D, Q, 0, 0, X, N ? 2 : 1, null, !1, I, M, G), G += "";
            var P, H, Y, V, U, B, u, z, g, A, W, j, F = M.split(", ").join(",").split(" "), m = G.split(", ").join(",").split(" "), L = F.length, q = au !== !1;
            for ((-1 !== G.indexOf(",") || -1 !== M.indexOf(",")) && (F = F.join(" ").replace(bc, ", ").split(" "), m = m.join(" ").replace(bc, ", ").split(" "), L = F.length), L !== m.length && (F = (J || "").split(" "), L = F.length), X.plugin = K, X.setRatio = N, P = 0; L > P; P++) {
                if (V = F[P], U = m[P], z = parseFloat(V), z || 0 === z) {
                    X.appendXtra("", z, bz(U, z), U.replace(aM, ""), q && -1 !== U.indexOf("px"), !0)
                } else {
                    if (E && ("#" === V.charAt(0) || aL[V] || a7.test(V))) {
                        j = "," === U.charAt(U.length - 1) ? ")," : ")", V = a9(V), U = a9(U), g = V.length + U.length > 6, g && !a1 && 0 === U[3] ? (X["xs" + X.l] += X.l ? " transparent" : "transparent", X.e = X.e.split(m[P]).join("transparent")) : (a1 || (g = !1), X.appendXtra(g ? "rgba(" : "rgb(", V[0], U[0] - V[0], ",", !0, !0).appendXtra("", V[1], U[1] - V[1], ",", !0).appendXtra("", V[2], U[2] - V[2], g ? "," : j, !0), g && (V = 4 > V.length ? 1 : V[3], X.appendXtra("", V, (4 > U.length ? 1 : U[3]) - V, j, !1)))
                    } else {
                        if (B = V.match(aD)) {
        ...
        aK.xs0 = "", aK._next = aK._prev = aK.xfirst = aK.data = aK.plugin = aK.setRatio = aK.rxp = null, aK.appendXtra = function (d, h, c, g, f, k) {
            var b = this, j = b.l;
            return b["xs" + j] += k && j ? " " + d : d || "", c || 0 === j || b.plugin ? (b.l++, b.type = b.setRatio ? 2 : 1, b["xs" + b.l] = g || "", j > 0 ? (b.data["xn" + j] = h + c, b.rxp["xn" + j] = f, b["xn" + j] = h, b.plugin || (b.xfirst = new ay(b, "xn" + j, h, c, b.xfirst || b, 0, b.n, f, b.pr), b.xfirst.xs0 = 0), b) : (b.data = {s: h + c}, b.rxp = {}, b.s = h, b.c = c, b.r = f, b)) : (b["xs" + j] += h + (g || ""), b)
        };
        var bw = function (a, b) {
            b = b || {}, this.p = b.prefix ? bk(a) || a : a, aG[a] = aG[this.p] = this, this.format = b.formatter || bE(b.defaultValue, b.color, b.collapsible, b.multi), b.parser && (this.parse = b.parser), this.clrs = b.color, this.multi = b.multi, this.keyword = b.keyword, this.dflt = b.defaultValue, this.pr = b.priority || 0
        ...
        aK = bw.prototype, aK.parseComplex = function (y, v, k, b, z, g) {
        ...
        var bJ, bD = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","), ah = bk("transform"), a3 = a0 + "transform", aS = bk("transformOrigin"), bK = null !== bk("perspective"), bb = aX.Transform = function () {
        ...
        }, ai = window.SVGElement, ad = function (b, f, a) {
            var d, c = aY.createElementNS("http://www.w3.org/2000/svg", b), g = /([a-z])([A-Z])/g;
            for (d in a) {
                c.setAttributeNS(null, d.replace(g, "$1-$2").toLowerCase(), a[d])
            }
            return f.appendChild(c), c
        }, bq = document.documentElement, bF = function () {
            var b, d, a, c = aP || /Android/i.test(bs) && !window.chrome;
            return aY.createElementNS && !c && (b = ad("svg", bq), d = ad("rect", b, {
                width : 100,
                height: 50,
                x     : 100
            }), a = d.getBoundingClientRect().width, d.style[aS] = "50% 50%", d.style[ah] = "scaleX(0.5)", c = a === d.getBoundingClientRect().width, bq.removeChild(b)), c
        }(), aF = function (b, d, a) {
            var c = b.getBBox();
            d = bH(d).split(" "), a.xOrigin = (-1 !== d[0].indexOf("%") ? parseFloat(d[0]) / 100 * c.width : parseFloat(d[0])) + c.x, a.yOrigin = (-1 !== d[1].indexOf("%") ? parseFloat(d[1]) / 100 * c.height : parseFloat(d[1])) + c.y
        }, bI = aX.getTransform = function (b3, ch, cd, b4) {
            if (b3._gsTransform && cd && !b4) {
                return b3._gsTransform
            }
            var b8, b7, ca, ce, b2, cg, b6, cl, cj, ci, b9 = cd ? b3._gsTransform || new bb : new bb, cf = 0 > b9.scaleX, b1 = 0.00002, bY = 100000, bZ = bK ? parseFloat(bl(b3, aS, ch, !1, "0 0 0").split(" ")[2]) || b9.zOrigin || 0 : 0, N = parseFloat(aU.defaultTransformPerspective) || 0;
            if (ah ? b7 = bl(b3, a3, ch, !0) : b3.currentStyle && (b7 = b3.currentStyle.filter.match(bt), b7 = b7 && 4 === b7.length ? [b7[0].substr(4), Number(b7[2].substr(4)), Number(b7[1].substr(4)), b7[3].substr(4), b9.x || 0, b9.y || 0].join(",") : ""), b8 = !b7 || "none" === b7 || "matrix(1, 0, 0, 1, 0, 0)" === b7, b9.svg = !!(ai && "function" == typeof b3.getBBox && b3.getCTM && (!b3.parentNode || b3.parentNode.getBBox && b3.parentNode.getCTM)), b9.svg && (aF(b3, bl(b3, aS, aw, !1, "50% 50%") + "", b9), bJ = aU.useSVGTransformAttr || bF, ca = b3.getAttribute("transform"), b8 && ca && -1 !== ca.indexOf("matrix") && (b7 = ca, b8 = 0)), !b8) {
                for (ca = (b7 || "").match(/(?:\-|\b)[\d\-\.e]+\b/gi) || [], ce = ca.length; --ce > -1;) {
                    b2 = Number(ca[ce]), ca[ce] = (cg = b2 - (b2 |= 0)) ? (0 | cg * bY + (0 > cg ? -0.5 : 0.5)) / bY + b2 : b2
                }
                if (16 === ca.length) {
                    var b0 = ca[8], ck = ca[9], bM = ca[10], ae = ca[12], bV = ca[13], be = ca[14];
                    b9.zOrigin && (be = -b9.zOrigin, ae = b0 * be - ca[12], bV = ck * be - ca[13], be = bM * be + b9.zOrigin - ca[14]);
                    var cb, bN, bU, bO, bP, bX = ca[0], A = ca[1], bQ = ca[2], bS = ca[3], bT = ca[4], s = ca[5], bW = ca[6], K = ca[7], cc = ca[11], G = Math.atan2(A, s);
                    b9.rotation = G * ba, G && (bO = Math.cos(-G), bP = Math.sin(-G), bX = bX * bO + bT * bP, bN = A * bO + s * bP, s = A * -bP + s * bO, bW = bQ * -bP + bW * bO, A = bN), G = Math.atan2(b0, bX), b9.rotationY = G * ba, G && (bO = Math.cos(-G), bP = Math.sin(-G), cb = bX * bO - b0 * bP, bN = A * bO - ck * bP, bU = bQ * bO - bM * bP, ck = A * bP + ck * bO, bM = bQ * bP + bM * bO, cc = bS * bP + cc * bO, bX = cb, A = bN, bQ = bU), G = Math.atan2(bW, bM), b9.rotationX = G * ba, G && (bO = Math.cos(-G), bP = Math.sin(-G), cb = bT * bO + b0 * bP, bN = s * bO + ck * bP, bU = bW * bO + bM * bP, b0 = bT * -bP + b0 * bO, ck = s * -bP + ck * bO, bM = bW * -bP + bM * bO, cc = K * -bP + cc * bO, bT = cb, s = bN, bW = bU), b9.scaleX = (0 | Math.sqrt(bX * bX + A * A) * bY + 0.5) / bY, b9.scaleY = (0 | Math.sqrt(s * s + ck * ck) * bY + 0.5) / bY, b9.scaleZ = (0 | Math.sqrt(bW * bW + bM * bM) * bY + 0.5) / bY, b9.skewX = 0, b9.perspective = cc ? 1 / (0 > cc ? -cc : cc) : 0, b9.x = ae, b9.y = bV, b9.z = be
                } else {
                    if (!(bK && !b4 && ca.length && b9.x === ca[4] && b9.y === ca[5] && (b9.rotationX || b9.rotationY) || void 0 !== b9.x && "none" === bl(b3, "display", ch))) {
                        var J = ca.length >= 6, b5 = J ? ca[0] : 1, bR = ca[1] || 0, bL = ca[2] || 0, a = J ? ca[3] : 1;
                        b9.x = ca[4] || 0, b9.y = ca[5] || 0, b6 = Math.sqrt(b5 * b5 + bR * bR), cl = Math.sqrt(a * a + bL * bL), cj = b5 || bR ? Math.atan2(bR, b5) * ba : b9.rotation || 0, ci = bL || a ? Math.atan2(bL, a) * ba + cj : b9.skewX || 0, Math.abs(ci) > 90 && 270 > Math.abs(ci) && (cf ? (b6 *= -1, ci += 0 >= cj ? 180 : -180, cj += 0 >= cj ? 180 : -180) : (cl *= -1, ci += 0 >= ci ? 180 : -180)), b9.scaleX = b6, b9.scaleY = cl, b9.rotation = cj, b9.skewX = ci, bK && (b9.rotationX = b9.rotationY = b9.z = 0, b9.perspective = N, b9.scaleZ = 1)
                    }
                }
                b9.zOrigin = bZ;
                for (ce in b9) {
            ...
            var Q, L, F = this.data, D = -F.rotation * bd, I = D + F.skewX * bd, V = 100000, H = (0 | Math.cos(D) * F.scaleX * V) / V, K = (0 | Math.sin(D) * F.scaleX * V) / V, M = (0 | Math.sin(I) * -F.scaleY * V) / V, A = (0 | Math.cos(I) * F.scaleY * V) / V, O = this.t.style, G = this.t.currentStyle;
            if (G) {
                L = K, K = -M, M = -L, Q = G.filter, O.filter = "";
                var W, T, J = this.t.offsetWidth, N = this.t.offsetHeight, z = "absolute" !== G.position, q = "progid:DXImageTransform.Microsoft.Matrix(M11=" + H + ", M12=" + K + ", M21=" + M + ", M22=" + A, x = F.x + J * F.xPercent / 100, U = F.y + N * F.yPercent / 100;
                if (null != F.ox && (W = (F.oxp ? 0.01 * J * F.ox : F.ox) - J / 2, T = (F.oyp ? 0.01 * N * F.oy : F.oy) - N / 2, x += W - (W * H + T * K), U += T - (W * M + T * A)), z ? (W = J / 2, T = N / 2, q += ", Dx=" + (W - (W * H + T * K) + x) + ", Dy=" + (T - (W * M + T * A) + U) + ")") : q += ", sizingMethod='auto expand')", O.filter = -1 !== Q.indexOf("DXImageTransform.Microsoft.Matrix(") ? Q.replace(bo, q) : q + " " + Q, (0 === B || 1 === B) && 1 === H && 0 === K && 0 === M && 1 === A && (z && -1 === q.indexOf("Dx=0, Dy=0") || a2.test(Q) && 100 !== parseFloat(RegExp.$1) || -1 === Q.indexOf("gradient(" && Q.indexOf("Alpha")) && O.removeAttribute("filter")), !z) {
                    var k, d, E, j = 8 > aP ? 1 : -1;
                    for (W = F.ieOffsetX || 0, T = F.ieOffsetY || 0, F.ieOffsetX = Math.round((J - ((0 > H ? -H : H) * J + (0 > K ? -K : K) * N)) / 2 + x), F.ieOffsetY = Math.round((N - ((0 > A ? -A : A) * N + (0 > M ? -M : M) * J)) / 2 + U), by = 0; 4 > by; by++) {
                        d = ac[by], k = G[d], L = -1 !== k.indexOf("px") ? parseFloat(k) : aW(this.t, d, parseFloat(k), k.replace(aq, "")) || 0, E = L !== F[d] ? 2 > by ? -F.ieOffsetX : -F.ieOffsetY : 2 > by ? W - F.ieOffsetX : T - F.ieOffsetY, O[d] = (F[d] = Math.round(L - E * (0 === by || 2 === by ? 1 : j))) + "px"
                    }
                }
            }
        }, bA = aX.set3DTransformRatio = function (bN) {
            var b0, bW, bP, bO, bS, b4, bR, bU, bX, bM, bZ, bQ, b2, b1, bT, bY, bL, Z, ae, q, be, b3, G, B, V, E = this.data, bV = this.t.style, H = E.rotation * bd, W = E.scaleX, U = E.scaleY, K = E.scaleZ, J = E.x, Y = E.y, j = E.z, L = E.perspective;
            ...
            if (H || E.skewX) {
                Z = Math.cos(H), ae = Math.sin(H), b0 = Z, bS = ae, E.skewX && (H -= E.skewX * bd, Z = Math.cos(H), ae = Math.sin(H), "simple" === E.skewType && (q = Math.tan(E.skewX * bd), q = Math.sqrt(1 + q * q), Z *= q, ae *= q)), bW = -ae, b4 = Z
            } else {
                if (!(E.rotationY || E.rotationX || 1 !== K || L || E.svg)) {
                    return bV[ah] = (E.xPercent || E.yPercent ? "translate(" + E.xPercent + "%," + E.yPercent + "%) translate3d(" : "translate3d(") + J + "px," + Y + "px," + j + "px)" + (1 !== W || 1 !== U ? " scale(" + W + "," + U + ")" : ""), void 0
                }
                b0 = b4 = 1, bW = bS = 0
            }
            bZ = 1, bP = bO = bR = bU = bX = bM = bQ = b2 = b1 = 0, bT = L ? -1 / L : 0, bY = E.zOrigin, bL = 100000, V = ",", H = E.rotationY * bd, H && (Z = Math.cos(H), ae = Math.sin(H), bX = bZ * -ae, b2 = bT * -ae, bP = b0 * ae, bR = bS * ae, bZ *= Z, bT *= Z, b0 *= Z, bS *= Z), H = E.rotationX * bd, H && (Z = Math.cos(H), ae = Math.sin(H), q = bW * Z + bP * ae, be = b4 * Z + bR * ae, b3 = bM * Z + bZ * ae, G = b1 * Z + bT * ae, bP = bW * -ae + bP * Z, bR = b4 * -ae + bR * Z, bZ = bM * -ae + bZ * Z, bT = b1 * -ae + bT * Z, bW = q, b4 = be, bM = b3, b1 = G), 1 !== K && (bP *= K, bR *= K, bZ *= K, bT *= K), 1 !== U && (bW *= U, b4 *= U, bM *= U, b1 *= U), 1 !== W && (b0 *= W, bS *= W, bX *= W, b2 *= W), bY && (bQ -= bY, bO = bP * bQ, bU = bR * bQ, bQ = bZ * bQ + bY), E.svg && (bO += E.xOrigin - (E.xOrigin * b0 + E.yOrigin * bW), bU += E.yOrigin - (E.xOrigin * bS + E.yOrigin * b4)), bO = (q = (bO += J) - (bO |= 0)) ? (0 | q * bL + (0 > q ? -0.5 : 0.5)) / bL + bO : bO, bU = (q = (bU += Y) - (bU |= 0)) ? (0 | q * bL + (0 > q ? -0.5 : 0.5)) / bL + bU : bU, bQ = (q = (bQ += j) - (bQ |= 0)) ? (0 | q * bL + (0 > q ? -0.5 : 0.5)) / bL + bQ : bQ, B = E.xPercent || E.yPercent ? "translate(" + E.xPercent + "%," + E.yPercent + "%) matrix3d(" : "matrix3d(", B += (0 | b0 * bL) / bL + V + (0 | bS * bL) / bL + V + (0 | bX * bL) / bL, B += V + (0 | b2 * bL) / bL + V + (0 | bW * bL) / bL + V + (0 | b4 * bL) / bL, B += V + (0 | bM * bL) / bL + V + (0 | b1 * bL) / bL + V + (0 | bP * bL) / bL, B += V + (0 | bR * bL) / bL + V + (0 | bZ * bL) / bL + V + (0 | bT * bL) / bL, B += V + bO + V + bU + V + bQ + V + (L ? 1 + -bQ / L : 1) + ")", bV[ah] = B
        }, bu = aX.set2DTransformRatio = function (F) {
            var z, w, b, G, k, C, j, v, x, E, y, g = this.data, D = this.t, B = D.style, A = g.x, q = g.y;
            return !(g.rotationX || g.rotationY || g.z || g.force3D === !0 || "auto" === g.force3D && 1 !== F && 0 !== F) || g.svg && bJ || !bK ? (G = g.scaleX, k = g.scaleY, g.rotation || g.skewX || g.svg ? (z = g.rotation * bd, w = z - g.skewX * bd, b = 100000, C = Math.cos(z) * G, j = Math.sin(z) * G, v = Math.sin(w) * -k, x = Math.cos(w) * k, g.svg && (A += g.xOrigin - (g.xOrigin * C + g.yOrigin * v), q += g.yOrigin - (g.xOrigin * j + g.yOrigin * x), y = 0.000001, y > A && A > -y && (A = 0), y > q && q > -y && (q = 0)), E = (0 | C * b) / b + "," + (0 | j * b) / b + "," + (0 | v * b) / b + "," + (0 | x * b) / b + "," + A + "," + q + ")", g.svg && bJ ? D.setAttribute("transform", "matrix(" + E) : B[ah] = (g.xPercent || g.yPercent ? "translate(" + g.xPercent + "%," + g.yPercent + "%) matrix(" : "matrix(") + E) : B[ah] = (g.xPercent || g.yPercent ? "translate(" + g.xPercent + "%," + g.yPercent + "%) matrix(" : "matrix(") + G + ",0,0," + k + "," + A + "," + q + ")", void 0) : (this.setRatio = bA, bA.call(this, F), void 0)
        };
        aK = bb.prototype, aK.x = aK.y = aK.z = aK.skewX = aK.skewY = aK.rotation = aK.rotationX = aK.rotationY = aK.zOrigin = aK.xPercent = aK.yPercent = 0, aK.scaleX = aK.scaleY = aK.scaleZ = 1, an("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent", {
            parser: function (s, I, E, w, B, A, D) {
                if (w._lastParsedTransform === D) {
                    return B
                }
                w._lastParsedTransform = D;
                var F, q, H, z, L, K, J, C = w._transform = bI(s, aw, !0, D.parseTransform), G = s.style, k = 0.000001, b = bD.length, j = D, a = {};
            ...
            defaultValue: "0px", parser: function (B, L, H, E, Q) {
                L = this.format(L);
                var D, G, I, A, K, C, R, N, M, F, J, z, q, r, j, s, O = ["borderTopLeftRadius", "borderTopRightRadius", "borderBottomRightRadius", "borderBottomLeftRadius"], k = B.style;
                for (M = parseFloat(B.offsetWidth), F = parseFloat(B.offsetHeight), D = L.split(" "), G = 0; O.length > G; G++) {
                    this.p.indexOf("border") && (O[G] = bk(O[G])), K = A = bl(B, O[G], aw, !1, "0px"), -1 !== K.indexOf(" ") && (A = K.split(" "), K = A[0], A = A[1]), C = I = D[G], R = parseFloat(K), z = K.substr((R + "").length), q = "=" === C.charAt(1), q ? (N = parseInt(C.charAt(0) + "1", 10), C = C.substr(2), N *= parseFloat(C), J = C.substr((N + "").length - (0 > N ? 1 : 0)) || "") : (N = parseFloat(C), J = C.substr((N + "").length)), "" === J && (J = ax[H] || z), J !== z && (r = aW(B, "borderLeft", R, z), j = aW(B, "borderTop", R, z), "%" === J ? (K = 100 * (r / M) + "%", A = 100 * (j / F) + "%") : "em" === J ? (s = aW(B, "borderLeft", 1, "em"), K = r / s + "em", A = j / s + "em") : (K = r + "px", A = j + "px"), q && (C = parseFloat(K) + N + J, I = parseFloat(A) + N + J)), Q = ak(k, O[G], K + " " + A, C + " " + I, !1, "0px", Q)
                }
                return Q
            }, prefix   : !0, formatter: bE("0px 0px 0px 0px", !1, !0)
        }), an("backgroundPosition", {
            defaultValue: "0 0", parser: function (E, z, v, b, k, B) {
                var j, s, w, D, y, d, C = "background-position", A = aw || a6(E, null), q = this.format((A ? aP ? A.getPropertyValue(C + "-x") + " " + A.getPropertyValue(C + "-y") : A.getPropertyValue(C) : E.currentStyle.backgroundPositionX + " " + E.currentStyle.backgroundPositionY) || "0 0"), x = this.format(z);
                if (-1 !== q.indexOf("%") != (-1 !== x.indexOf("%")) && (d = bl(E, "backgroundImage").replace(a5, ""), d && "none" !== d)) {
                    for (j = q.split(" "), s = x.split(" "), bn.setAttribute("src", d), w = 2; --w > -1;) {
                        q = j[w], D = -1 !== q.indexOf("%"), D !== (-1 !== s[w].indexOf("%")) && (y = 0 === w ? E.offsetWidth - bn.width : E.offsetHeight - bn.height, j[w] = D ? parseFloat(q) / 100 * y + "px" : 100 * (parseFloat(q) / y) + "%")
                    }
                    q = j.join(" ")
                }
                return this.parseComplex(E.style, q, x, k, B)
            }, formatter: bH
        }), an("backgroundSize", {defaultValue: "0 0", formatter: bH}), an("perspective", {
            defaultValue: "0px",
            prefix      : !0
        }), an("perspectiveOrigin", {
            defaultValue: "50% 50%",
            prefix      : !0
        }), an("transformStyle", {prefix: !0}), an("backfaceVisibility", {prefix: !0}), an("userSelect", {prefix: !0}), an("margin", {parser: am("marginTop,marginRight,marginBottom,marginLeft")}), an("padding", {parser: am("paddingTop,paddingRight,paddingBottom,paddingLeft")}), an("clip", {
            defaultValue: "rect(0px,0px,0px,0px)",
            parser      : function (p, k, g, b, d, m) {
                var c, f, j;
                return 9 > aP ? (f = p.currentStyle, j = 8 > aP ? " " : ",", c = "rect(" + f.clipTop + j + f.clipRight + j + f.clipBottom + j + f.clipLeft + ")", k = this.format(k).split(",").join(j)) : (c = this.format(bl(p, this.p, aw, !1, this.dflt)), k = this.format(k)), this.parseComplex(p.style, c, k, d, m)
            }
        }), an("textShadow", {
        ...
        }), an("borderWidth", {parser: am("borderTopWidth,borderRightWidth,borderBottomWidth,borderLeftWidth")}), an("float,cssFloat,styleFloat", {
        ...
        var aj = function (b) {
            var f, a = this.t, d = a.filter || bl(this.data, "filter") || "", c = 0 | this.s + this.c * b;
            100 === c && (-1 === d.indexOf("atrix(") && -1 === d.indexOf("radient(") && -1 === d.indexOf("oader(") ? (a.removeAttribute("filter"), f = !bl(this.data, "filter")) : (a.filter = d.replace(aT, ""), f = !0)), f || (this.xn1 && (a.filter = d = d || "alpha(opacity=" + c + ")"), -1 === d.indexOf("pacity") ? 0 === c && this.xn1 || (a.filter = d + " alpha(opacity=" + c + ")") : a.filter = d.replace(a2, "opacity=" + c))
        };
        an("opacity,alpha,autoAlpha", {
            defaultValue: "1", parser: function (p, k, g, b, d, m) {
                var c = parseFloat(bl(p, "opacity", aw, !1, "1")), f = p.style, j = "autoAlpha" === g;
                return "string" == typeof k && "=" === k.charAt(1) && (k = ("-" === k.charAt(0) ? -1 : 1) * parseFloat(k.substr(2)) + c), j && 1 === c && "hidden" === bl(p, "visibility", aw) && 0 !== k && (c = 0), a1 ? d = new ay(f, "opacity", c, k - c, d) : (d = new ay(f, "opacity", 100 * c, 100 * (k - c), d), d.xn1 = j ? 1 : 0, f.zoom = 1, d.type = 2, d.b = "alpha(opacity=" + d.s + ")", d.e = "alpha(opacity=" + (d.s + d.c) + ")", d.data = p, d.plugin = m, d.setRatio = aj), j && (d = new ay(f, "visibility", 0, 0, d, -1, null, !1, 0, 0 !== c ? "inherit" : "hidden", 0 === k ? "hidden" : "inherit"), d.xs0 = "inherit", b._overwriteProps.push(d.n), b._overwriteProps.push(g)), d
            }
        });
        var bj = function (a, b) {
        ...
        an("className", {
            parser: function (A, s, b, j, x, i, k) {
                ...
                return A._gsClassPT = x, x.e = "=" !== s.charAt(1) ? s : w.replace(RegExp("\\s*\\b" + s.substr(2) + "\\b"), "") + ("+" === s.charAt(0) ? " " + s.substr(2) : ""), j._tween._duration && (A.setAttribute("class", x.e), m = bg(A, z, bf(A), k, g), A.setAttribute("class", w), x.data = m.firstMPT, A.style.cssText = v, x = x.xfirst = j.parse(A, m.difs, x, i)), x
            }
        });
        var al = function (d) {
            if ((1 === d || 0 === d) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                var h, c, g, f, j = this.t.style, b = aG.transform.parse;
                if ("all" === this.e) {
                    j.cssText = "", f = !0
                } else {
        ...
        }), aK = "bezier,throwProps,physicsProps,physics2D".split(","), by = aK.length; by--;) {
            bC(aK[by])
        }
        aK = aU.prototype, aK._firstPT = aK._lastParsedTransform = aK._transform = null, aK._onInitTween = function (u, k, a) {
            if (!u.nodeType) {
                return !1
            }
            ...
            var c, i, s, n, b, j, r, p, q, f = u.style;
            if (aN && "" === f.zIndex && (c = bl(u, "zIndex", aw), ("auto" === c || "" === c) && this._addLazySet(f, "zIndex", 0)), "string" == typeof k && (n = f.cssText, c = bf(u, aw), f.cssText = n + ";" + k, c = bg(u, c, bf(u)).difs, !a1 && ar.test(k) && (c.opacity = parseFloat(RegExp.$1)), k = c, f.cssText = n), this._firstPT = i = this.parse(u, k, null), this._transformType) {
                for (q = 3 === this._transformType, ah ? aA && (aN = !0, "" === f.zIndex && (r = bl(u, "zIndex", aw), ("auto" === r || "" === r) && this._addLazySet(f, "zIndex", 0)), aQ && this._addLazySet(f, "WebkitBackfaceVisibility", this._vars.WebkitBackfaceVisibility || (q ? "visible" : "hidden"))) : f.zoom = 1, s = i; s && s._next;) {
                    s = s._next
                }
        ...
        aK._addLazySet = function (b, d, a) {
            ...
            return d.className && (a = this._classNamePT) && (b = a.xfirst, b && b._prev ? this._linkCSSP(b._prev, a._next, b._prev._prev) : b === this._firstPT && (this._firstPT = a._next), a._next && this._linkCSSP(a._next, a._next._next, b._prev), this._classNamePT = null), av.prototype._kill.call(this, f)
        };
        ...
        return aU.cascadeTo = function (w, j, b) {
            var x, e, q, d = aO.to(w, j, b), g = [d], k = [], v = [], m = [], c = aO._internals.reservedProps;
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
    _gsScope._gsDefine("easing.Back", ["easing.Ease"], function (F) {
        var z, w, G, b = _gsScope.GreenSockGlobals || _gsScope, k = b.com.greensock, C = 2 * Math.PI, j = Math.PI / 2, x = k._class, v = function (f, a) {
    ...
    if (!aL.TweenLite) {
        var aB, aC, aG, aT, aF, aI = function (a) {
            ...
            this.check = function (k) {
                ...
                if (0 === g && f) {
                    for (i = ("com.greensock." + c).split("."), a = i.pop(), l = aI(i.join("."))[a] = this.gsClass = f.apply(f, e), b && (aL[a] = l, "function" == typeof define && define.amd ? define((aA.GreenSockAMDPath ? aA.GreenSockAMDPath + "/" : "") + c.split(".").pop(), [], function () {
                        return l
                    }) : c === aP && "undefined" != typeof module && module.exports && (module.exports = l)), n = 0; this.sc.length > n; n++) {
                        this.sc[n].check()
                    }
                }
            }, this.check(!0)
        ...
        ay("Ticker", function (A, q) {
            var k, B, a, g, j, m = this, z = Z(), o = q !== !1 && aJ, x = 500, b = 33, w = "tick", y = function (d) {
                var f, c, h = Z() - aw;
            ...
            aS.call(m), m.time = m.frame = 0, m.tick = function () {
                ...
                null !== a ? m.sleep() : m.frame > 10 && (aw = Z() - x + 5), B = 0 === k ? aH : o && aJ ? aJ : function (c) {
        ...
        var aj = ay("TweenLite", function (h, d, f) {
            ...
            var g, k, c, j = h.jquery || h.length && h !== aA && h[0] && (h[0] === aA || h[0].nodeType && h[0].style && !h.nodeType), b = this.vars.overwrite;
        ...
        var au = [], ag = {}, ae = aj._internals = {
            isArray   : aO,
            isSelector: an,
            lazyTweens: au
        }, X = aj._plugins = {}, am = ae.tweenLookup = {}, aK = 0, al = ae.reservedProps = {
            ease                   : 1,
            delay                  : 1,
            overwrite              : 1,
            onComplete             : 1,
        ...
        aG._init = function () {
            var p, k, g, q, b, d = this.vars, m = this._overwrittenProps, c = this._duration, f = !!d.immediateRender, j = d.ease;
            if (d.startAt) {
            ...
            if (y >= j) {
                this._totalTime = this._time = j, this.ratio = this._ease._calcEnd ? this._ease.getRatio(1) : 1, this._reversed || (z = !0, b = "onComplete"), 0 === j && (this._initted || !this.vars.lazy || k) && (this._startTime === this._timeline._duration && (y = 0), (0 === y || 0 > p || p === aU && "isPause" !== this.data) && p !== y && (k = !0, p > aU && (b = "onReverseComplete")), this._rawPrevTime = w = !v || y || p === y ? y : aU)
            } else {
                if (1e-7 > y) {
                    this._totalTime = this._time = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0, (0 !== c || 0 === j && p > 0 && p !== aU) && (b = "onReverseComplete", z = this._reversed), 0 > y && (this._active = !1, 0 === j && (this._initted || !this.vars.lazy || k) && (p >= 0 && (p !== aU || "isPause" !== this.data) && (k = !0), this._rawPrevTime = w = !v || y || p === y ? y : aU)), this._initted || (k = !0)
                } else {
...
window.Modernizr = (function (n, s, i) {
    var e = "2.8.3", l = {}, C = s.documentElement, D = "modernizr", A = s.createElement(D), o = A.style, f, v = {}.toString, x = " -webkit- -moz- -o- -ms- ".split(" "), c = "Webkit Moz O ms", F = c.split(" "), p = c.toLowerCase().split(" "), j = {}, d = {}, t = {}, z = [], u = z.slice, b, y = function (P, R, J, Q) {
        var I, O, L, M, H = s.createElement("div"), N = s.body, K = N || s.createElement("body");
        if (parseInt(J, 10)) {
            while (J--) {
    ...
    if (!Function.prototype.bind) {
        Function.prototype.bind = function G(J) {
            ...
            var H = u.call(arguments, 1), I = function () {
    ...
    function a(L, H, K) {
        var I = L.charAt(0).toUpperCase() + L.slice(1), J = (L + " " + F.join(I + " ") + I).split(" ");
...
var CMUtiles = CMUtiles || (function () {
        ...
        function b(x, z, w, y) {
            var v = (w - x), u = (y - z), A = Math.sqrt(v * v + u * u);
            return A
        }
        ...
        function l(y, D, C, x) {
            var w = y / D, v = C / x, B = y, u = D, A = 0, z = 0;
            if (v > w) {
                B = (0.5 + (C * (D / x))) | 0;
                A = (0.5 + ((y - B) / 2)) | 0
            } else {
        ...
        function o(v, y, x, z) {
            var w = (v % y) * x, u = ((v / y) | 0) * z;
            return {x: w, y: u}
        }

        function m(w, v, x, u) {
            var z = (screen.width - x) >> 1, y = (screen.height - u) >> 1;
            window.open(w, v, "top=" + y + ",left=" + z + ",width=" + x + ",height=" + u)
        }

        function p(v, B) {
            var A = v.toString(), z = "", u = A.length, y = B + 1;
            if (u < y) {
                var x = y - u, w;
                for (w = 1; w <= x; w++) {
                    z += "0"
        ...
        function c(x, w) {
            var v = x.toString().split(""), z = v.length, u = (z / 3), y, A = (u << 0);
            A = (A == u) ? A : A + 1;
            for (y = 1; y < A; y++) {
                v.splice(z - y * 3, 0, w)
            }
...
(function (c) {
    ...
    var a, l, g, p, q = (i(document.documentElement, "addEventListener", "removeEventListener") && i(window, "addEventListener", "removeEventListener")), n = (i(document.documentElement, "attachEvent", "detachEvent") && i(window, "attachEvent", "detachEvent")), o = {}, f = {};
    g = function (t, r, u) {
        if (!t.eventHolder) {
            return false
        } else {
...
(function () {
    function c(n, j) {
        ...
        if (!Event.prototype.stopImmediatePropagation) {
            ...
            n.addEventListener = function (q, r, l) {
                ...
                if (q === "click") {
                    i.call(n, q, r.hijacked || (r.hijacked = function (s) {
    ...
    c.prototype.touchHasMoved = function (g) {
        var i = g.changedTouches[0], h = this.touchBoundary;
    ...
    c.prototype.onTouchEnd = function (i) {
        var k, j, h, m, l, g = this.targetElement;
        if (!this.trackingClick) {
            return true
        }
        if ((i.timeStamp - this.lastClickTime) < this.tapDelay) {
...
var StageController = StageController || (function () {
        var c = {stageWidth: 0, stageHeight: 0, maxWidth: 0, maxHeight: 0}, b = [], a = [], h;
        ...
        function f() {
            var j = h.offsetWidth, l = h.offsetHeight;
            if (c.maxWidth > 0) {
...
var Address = Address || (function () {
        var h = {}, z, B, b, c = 0, l = 0, w = 0, x, p = true;
        ...
        function t() {
            ...
            if (CMDetect.VENDOR != "webkit" && CMDetect.VENDOR != "Moz" && CMDetect.VENDOR != "ms") {
                ...
                z.className = "admin";
                z.innerHTML = '<h1>Oops!</h1><div class="message">Material Interaction was created with HTML5 and CSS3.<br>It\'s a Chrome experiment and you can see perfectly on Chrome browser.<br>Please use <a href="http://www.google.com/chrome" target="_blank">Google Chrome browser</a>.</div>';
                return
            }
...
var Index = Index || (function () {
        var E, s, i, C, e, l, f, d, c, y, A = 40, b = 80, k, B, h, z = [], r = 0, o = 1, m = 1;
        ...
        function x(I, H) {
            ...
            var J, K;
            for (J = 0; J < 5; J++) {
                K = new UI.item(J, CMDetect.colors[J]);
                s.appendChild(K.dom);
                z.push(K)
            }
            ...
            StageController.addResize("index", D);
            Loading.init(E, i, e, l)
        }
        ...
        function F() {
            ...
            z[1].setPos(f, d, 0, d);
            z[2].setPos(f, y, f, d);
            z[3].setPos(c, y, f, d + y);
            z[4].setPos(c, y, f + c, d + y)
        }
        ...
        function t(I) {
            ...
            a(I);
            var H = z[I];
            k = {x: H.x + A, y: H.y + A, w: H.w - b, h: H.h - b, color: H.color};
            B = {no: 0};
            z[h].hide();
            TweenLite.delayedCall(0.3, q)
        }

        function q() {
            E.appendChild(i);
            TweenLite.to(k, 1, {x: 0, y: 0, w: e, h: l, alpha: 0.8, ease: Expo.easeInOut, onComplete: w});
            TweenLite.to(B, 1, {no: 0.8, ease: Cubic.easeOut});
            m = 0;
            j()
        }
        ...
        function G(I) {
            ...
            E.appendChild(s);
            E.appendChild(i);
            k = {x: 0, y: 0, w: e, h: l, color: H.color};
            TweenLite.to(k, 1, {
                x         : H.x + A,
                y         : H.y + A,
                w         : H.w - b,
            ...
            B.no = 0.8;
            TweenLite.to(B, 1, {no: 0, ease: Cubic.easeIn});
            m = 0;
            j()
        }
        ...
        return {init: x, over: v, out: u, goSub: t, goBack: G, endLoad: g}
    })();
var Sub = Sub || (function () {
        var s, l, d, q, j, k, b, i, p, t = [1, 1, 1, 1, 1], c = 1;
        ...
        function f() {
            l.appendChild(j);
            TweenLite.to(j, 0.6, {
                delay: 1, css: {opacity: 1}, ease: Cubic.easeOut, onStart: function () {
                    Address.addCancel()
                }
            });
        ...
        function h() {
            ...
            TweenLite.to(j, 0.3, {
                css: {opacity: 0}, ease: Cubic.easeOut, onComplete: function () {
...
var About = About || (function () {
        var x, B, P, H, O, a, y, E, D, q, p, h, f, m, t, N, K, i, g, z, k = 1.4, e = 100, C = 70, b, u = 0;
        ...
        function r() {
            ...
            var R = CMUtiles.distance(0, 0, m, t), Q = R * 0.1 | 0;
            if (Q < 40) {
                Q = 40
            } else {
                if (Q > 100) {
        ...
        function c() {
            var Q = "https://www.facebook.com/dialog/feed?app_id=" + CMDetect.APP_ID + "&link=" + encodeURIComponent(CMDetect.SITE_URL) + "&picture=" + encodeURIComponent(CMDetect.SITE_URL + "images/share.png") + "&name=" + encodeURIComponent(CMDetect.TITLE) + "&caption=" + encodeURIComponent(CMDetect.SITE_URL) + "&description=" + encodeURIComponent("Interactive experiences for Google's Material Design Principles.") + "&redirect_uri=" + encodeURIComponent(CMDetect.SITE_URL + "close.html") + "&display=popup";
...
var Loading = Loading || (function () {
        var s, e, j, g, q, m, d = 0, e, j, f, b, a, o, h, c, l = {}, k = 1;
        ...
        function n(E, u, I, B) {
            ...
            var t = 1, z = 1.5, G = 0.22, v = 0.6, w = Expo.easeOut, J, C, H, A, F, y, D, x;
...
UI.actionBall.prototype = {
    resize   : function (c, e, b, a, d) {
        ...
        this.ctx.closePath();
        this.ctx.restore();
        var d = this.r * 2, b = d * 0.3 | 0, e = d * 0.04 | 0, g = -(b >> 1), f = -(e >> 1), c = -(e >> 1), a = -(b >> 1);
        this.ctx.save();
...
var SurfaceItem = SurfaceItem || (function () {
        ...
        function e(j, k, i, p) {
            ...
            var o = (j - a) >> 1, n = (k / 3 | 0) - (a / 2) | 0, m = (j - d) >> 1, l = (k - ((k - (n + a)) >> 1)) - (d >> 1);
            f.style.width = a + "px";
            f.style.height = a + "px";
...
var ActionItem = ActionItem || (function () {
        ...
        function d(t, m, r, p) {
            ...
            c = k - q;
            var o = (t - c) >> 1, n = (m - c) >> 1, s = c * 0.3 | 0, l = c * 0.04 | 0, j = o + (c - s >> 1), i = n + (c - l >> 1), v = o + (c - l >> 1), u = n + (c - s >> 1);
            a.style.width = c + "px";
            a.style.height = c + "px";
...
var MotionItem = MotionItem || (function () {
        ...
        function e(s, n, r, q) {
            ...
            var k = a / 4 | 0, u = k + a, t = s * 1.2, o = n * 1.2, m = t, l = o - a, j = t - a, i = o, p;
            f.style.width = a + "px";
            f.style.height = a + "px";
...
var InteractionItem = InteractionItem || (function () {
        ...
        function f(t, o, s, r) {
            var p = 524, j = 514, n, l, q, u, k = 1, m, i;
            d.width = t;
            d.height = o;
            b = d.getContext("2d");
...
var Surface = Surface || (function () {
        var d, k, t, w, f, g = 1, x = CMDetect.colors[0], i, r, m, j, l, o = 470, u = 100, K = 8, C, D, e, F, A, G, J, B = 0, s = 1;
        ...
        function P() {
            var T = m + (o >> 1) - 10, S = l + (o >> 1) - 10, R = o / 6 | 0, Q = S + R + 25;
            f.clearRect(0, 0, i, r);
            f.save();
            f.beginPath();
        ...
        function H() {
            var T = (i - o) >> 1, S = l - (o / 2) | 0, Q = CMUtiles.randomInteger(0, 3), R = 0.5;
            g = 1;
            B = 0;
            d.appendChild(k);
            e.w = 0;
        ...
        function z(X, W, Z) {
            var aa = X.x - W, Q = X.maxX + W, Y = X.y - W, ad = X.maxY + W;
            if (F.x > aa && F.x < Q && F.y > Y && F.y < ad) {
                var S = Math.abs(aa - F.x), V = Math.abs(F.x - Q), R = Math.abs(Y - F.y), U = Math.abs(F.y - ad), ac = Math.min(S, V), ab = Math.min(R, U), T = Math.min(ac, ab);
                if (T == S) {
                    F.x = aa - Z;
                    F.vx *= -1
                } else {
...
var Action = Action || (function () {
        var h, p, z, E, k, l = 1, o, u, N = CMDetect.colors[1], M = "#fbb447", j, v, d = 0, w, A, P = 8, U = 0.4, y = 0, S = 5, c = {}, J = [], K, b = 0, i = 0, O, H = 0, x = 1;
        ...
        function V() {
            var Z = o >> 1, Y = u >> 1, X = A / 2 | 0, W = Y + X + 25;
            k.clearRect(0, 0, o, u);
            k.save();
            k.beginPath();
        ...
        function q(aa, Y, ae, ad) {
            var Z = CMUtiles.distance(0, 0, ae, ad), X = CMUtiles.distance(aa, 0, ae, ad), W = CMUtiles.distance(0, Y, ae, ad), af = CMUtiles.distance(aa, Y, ae, ad), ac = Math.max(Z, X), ab = Math.max(W, af);
...
var Motion = Motion || (function () {
        var u, j, A, q, s, b = 1, h = CMDetect.colors[2], d, n, t, z, r, f, e, H, g = 0, c = 0, p = 1;
        ...
        function G() {
            var L = (t >> 1) + r, K = (t >> 1) + r, J = t / 4 | 0, I = K + J + 25;
            s.clearRect(0, 0, d, n);
            s.save();
            s.beginPath();
        ...
        function C() {
            ...
            TweenLite.to(f, I - 0.2, {
                r: t, x: r, y: r, ease: Back.easeOut, easeParames: [2.2], onUpdate: function () {
                    f.update()
                }
            });
            e.x = r;
            ...
            TweenLite.to(e, I - 0.2, {
                delay     : 0.2, x: J, y: n, ease: Cubic.easeInOut, onUpdate: function () {
                    e.update()
                }, onStart: function () {
                    g = 1
                }
        ...
        function m() {
            var J = f.x + (f.r >> 1), I = f.y + (f.r >> 1);
            c = 0;
            b = 0;
            TweenLite.to(e, 0.4, {
                x            : f.x, y: f.y, ease: Cubic.easeInOut, onUpdate: function () {
                    e.update()
                }, onComplete: function () {
                    g = 0
                }
        ...
        function a() {
            var I = CMUtiles.distance(r, r, f.x, f.y), K = CMUtiles.distance(0, 0, d, n), J = CMUtiles.getCurrent(I, 0, K, t, z);
            f.updateSize(J);
            e.updateSize(J)
        }

        function i() {
            var L = d >> 1, N = t >> 1, K, J, I, S, R, Q, P, O, M;
            A.save();
            if (n > d) {
                K = f.x;
                J = f.maxY;
...
var Change = Change || (function () {
        var e, k, q, w, f, g = 1, x = CMDetect.colors[3], j, o, r, u = 12, h = 17, I = h * 2, a, v, C, b = {no: 0}, E, A = 0, p = 1;
        ...
        function K() {
            var O = j - (j / 5 | 0), N = o >> 1, M = r * 1.5 | 0, L = N + M + 25;
            f.clearRect(0, 0, j, o);
            f.save();
            f.beginPath();
            f.fillStyle = "rgba(0,0,0,0.8)";
        ...
        function z() {
            var S, P, M, R, O, L = u * b.no, Q = C.x, N = C.y;
            for (R = 0; R <= a; R++) {
                for (O = 0; O <= v; O++) {
                    P = h + R * I;
                    S = h + O * I;
...
var Interaction = Interaction || (function () {
        var e, q, F, M, g, j = 1, N = CMDetect.colors[4], W = "#1f4388", V = "#ef4d80", T = 0, n, y, t, I, s, r, S, u, f, l = 0, i, Z, G, A, K, X = 40, h = 0.3, ak = Circ.easeOut, o = 524, E = 514, ae = 240, b = 142, aa, k, ag, H = [], z = [], a = 0, ab, R = 0, Y = 0, P = 0, B = 1;
        ...
        function aj(ap) {
            var ao = n >> 1, an = y >> 1, am = 80 * ap | 0, al = an + am + 25;
            g.clearRect(0, 0, n, y);
            g.save();
            g.beginPath();
        ...
        function x() {
            var am = o, ao = E, an, ar, aq = 1, ap, al;
        ...
        function U() {
            var am = 1, an = {
                ...
                b7: aa.b7,
                b8: aa.b8
            }, al = an.a7 + (an.b3 - an.a7 >> 1), ao = an.a8;
            j = 1;
            P = 0;
            Y = 0;
            e.appendChild(q);
        ...
        function p() {
            ...
            TweenLite.to(ag, 0.35, {
                delay: 0.15, ty: i, ease: ak, onUpdate: function () {
                    ag.update()
                }
            });
            TweenLite.to(k, 0.5, {
                ty           : K, ease: ak, onUpdate: function () {
                    k.update()
                }, onComplete: m
            })
        }
        ...
        function ac() {
            ...
            TweenLite.to(ag, 0.35, {
                ty: aa.ty, ease: ak, onUpdate: function () {
                    ag.update()
                }
            });
            TweenLite.to(k, 0.4, {
        ...
        function D() {
            Y = 0;
            var al = aa.a7 + (aa.b3 - aa.a7 >> 1), am = aa.a8;
            TweenLite.to(aa, 0.4, {
                a3         : al,
                a4         : am,
                a7         : al,
        ...
        function Q(am, al) {
            ...
            TweenLite.killTweensOf(ag);
            TweenLite.to(ag, h, {
                ty: A, ease: ak, onUpdate: function () {
                    ag.update()
                }
            })
        }
        ...
        function c() {
            ...
            if (A > Z && A < G) {
                TweenLite.to(ag, h, {
                    ty: i, ease: ak, onUpdate: function () {
                        ag.update()
                    }
                })
            } else {
                ...
                ao.moving = R;
                TweenLite.to(ao, h, {
                    ty           : am, ease: ak, onUpdate: function () {
                        ao.update()
                    }, onComplete: function () {
                        ao.isUsed = 0;
                        L(ao);
...
var Close = Close || (function () {
        var f, k, b, g, d = ["#ef4d80", "#1f4388", "#00a896", "#fcb447", "#904199", "#ff4081"];
